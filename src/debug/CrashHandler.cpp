...
static void PrintRegisters(ucontext_t* ctx, char* buffer, size_t* pos) {
    ...
    snprintf(regbuffer, std::size(regbuffer), "R0: 0x%08lX", ctx->uc_mcontext.arm_r0);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R1: 0x%08lX", ctx->uc_mcontext.arm_r1);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R2: 0x%08lX", ctx->uc_mcontext.arm_r2);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R3: 0x%08lX", ctx->uc_mcontext.arm_r3);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R4: 0x%08lX", ctx->uc_mcontext.arm_r4);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R5: 0x%08lX", ctx->uc_mcontext.arm_r5);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R6: 0x%08lX", ctx->uc_mcontext.arm_r6);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R7: 0x%08lX", ctx->uc_mcontext.arm_r7);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R8: 0x%08lX", ctx->uc_mcontext.arm_r8);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R9: 0x%08lX", ctx->uc_mcontext.arm_r9);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R10: 0x%08lX", ctx->uc_mcontext.arm_r10);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R11: 0x%08lX", ctx->uc_mcontext.arm_fp);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "R12: 0x%08lX", ctx->uc_mcontext.arm_ip);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "SP: 0x%08lX", ctx->uc_mcontext.arm_sp);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "LR: 0x%08lX", ctx->uc_mcontext.arm_lr);
    append_line(buffer, pos, regbuffer);
    snprintf(regbuffer, std::size(regbuffer), "PC: 0x%08lX", ctx->uc_mcontext.arm_pc);
    append_line(buffer, pos, regbuffer);
